{
    ...
    if (1 !== window[e]) {
        const t = this
          ...
          , {Blob: O, CustomEvent: N, Error: F, MouseEvent: V, Object: A, Promise: H, Response: q, Uint8Array: B, atob: G, addEventListener: W, cloneInto: J, chrome: X, dispatchEvent: z, removeEventListener: K} = t
          ...
          , {assign: pe, defineProperty: fe, getOwnPropertyDescriptor: we, getPrototypeOf: he, setPrototypeOf: ye, keys: ge} = A
          , {random: me} = Math
        ...
        (()=>{
            ...
            if (Te || null != (T = A) && T.runtime)
                ...
                const {Proxy: e} = t
                  ...
                  , c = (e,t,o,a)=>{
                    ...
                    if (void 0 === r)
                        return;
                    let c;
                    return c = _(a) ? a(o, r) : _(r) ? 0 === a || i(t) || !ee(o, t) ? I(n, r, o) : l(o, r) : R(r) && 0 !== a ? s(r, a) : r,
                    e[t] = c,
                    c
                }
                  , s = (t,n)=>new e({
                  ...
                  , l = (e,t,n)=>(...i)=>{
                    ...
                    try {
                        ...
                        if ("Extension context invalidated." !== e[a])
                            throw e;
                ...
                A = t.browser = s(X, {
                    ...
                    runtime: {
                        ...
                        getURL: 0,
                        onMessage: {
                            addListener: (e,t)=>o=>I(t, e, I(n, p, null, o))
                        },
                        sendMessage: w
                    },
                    tabs: !1
            ...
            const qe = (e,t)=>$(I($e, Me, e), t || 0)
              ...
              , Ye = (e,t)=>{
                ...
                return t && M(t) ? I(Xe, n, t) : t && I(te, ge(t), e=>{
              ...
              , ot = (e,t,a)=>{
                ...
                I(W, n, e, e=>{
                    ...
                    r)
                        ...
                        if (e || ((e = Q()).data = `[${o}] Non-cloneable property e.g. a DOM node or function.`),
                        J && (e = J(e, n)),
                        e.node && (r = e))
                            return
                    }
            ...
            it.push(({clipFF: e})=>{
                if (e) {
                    ...
                    ft = e=>{
                        ...
                        I(ve, e),
                        I(o, e),
                        I(t, I(n, e), wt.type || "text/plain", wt.data)
                    }
                    ,
                    ht = async t=>{
                        await ut[Se],
            ...
            st({
                ...
                GetResource({id: e, isBlob: t, key: n, raw: o}) {
                    var a;
                    return o || (o = ut.cache[(null == (a = ut.pathMaps[e]) ? void 0 : a[n]) || n]),
                    !o || Ze(o, t)
                },
                ...
                UnregisterMenu({id: e, key: t}) {
                    var n;
                    null == (n = yt[e]) || delete n[t],
                    _t(!0)
                }
            });
            const Rt = we(PageTransitionEvent[L], "persisted").get;
            let Lt, Ct, xt, Mt = 2 === Ee;
            function $t(e) {
                e.isTrusted && (this ? I(Rt, e) && Tt(0, "bfcache") : (Ee = 3,
                xt = ut[Se] = !1,
                Lt(),
                Tt(),
                Ee = 4))
            ...
            W("pageshow", $t),
            Mt && (I(W, Me, "prerenderingchange", $t.bind(null), {
                once: !0
            }),
            ut[Se] = new Promise(e=>Lt = e));
            const Dt = ut[s];
            let Ut, Pt, jt, It, Ot, Nt, Ft, Vt, At = n[e];
            function Ht(e) {
                Ot = !1;
                const o = e[m] + "VW"
                  , a = o + "*"
                ...
                , !0) : S(t, o, Kt, !1),
                l(opener) || l(n !== top && parent) ? d() : Gt({
                    code: `parent["${r}"] = [this, 0]`
                }, ()=>{
            ...
            async function qt(e, t) {
                ...
                i.gmi = {
                    isIncognito: X.extension.inIncognitoContext
                },
                Pt = Q(),
                Pt[f] = i,
                Pt[r] = i,
                ...
                const d = e[h].filter(e=>Bt(e) === r).map(e=>[e.id, e.key.data])
                  , u = (s || d.length) && et("InjectionFeedback", {
                    [c]: !Ot,
                    [r]: d,
                    [p]: s,
                ...
                s && (e = await u)) {
                    ...
                    await 0);
                    for (let t = 0, n = e[h]; t < n.length; t++)
                        Bt(n[t]);
                    jt && !y && Xt(),
                    await Wt("end"),
                    await Wt("idle")
            ...
            function Gt(e, t) {
                const {code: o} = e
                  ...
                  , i = Te && !t && (t=>{
                    ...
                    n && !`${n}`.includes(Le) || (U("error", [e.displayName], t.error),
                    t.preventDefault())
                }
                )
                  , c = Ye("div")
                ...
                Te || I(se, s, l)) : I(se, s, r),
                i && I(W, n, "error", i),
                Ft || I(se, qe("*") || Me, c),
                i && I(K, n, "error", i),
                t && (Ft = s,
                Te && I(se, s, l),
                (d = l.contentDocument) && (I(se, I($e, d, "*")[0], r),
                t()),
                I(de, l),
                Ft = null),
                I(de, r),
            ...
            function Cn(e, t, n) {
                ...
                return kn = I(oe, a, ()=>et("SetTimeout", 150)),
                a
            }
            async function xn(e) {
                await et("SetTimeout", 3e3),
                sn(e)
            }
            function Mn(e, t, n) {
                if (!e[v])
                    return void S(e[hn] || (e[hn] = [""]), n ? n.i : 0, t);
                const o = (t = G(t)).length
                  , a = e[hn] || (e[hn] = new B(n ? n.size : o));
                for (let e = (null == n ? void 0 : n.chunk) || 0, r = 0; r < o; )
                    a[e++] = ie(t, r++)
            }
            ...
            st({
                async HttpRequest(e, t) {
                    ...
                    const {events: o, url: a, [x]: r} = e
                      , i = I(ne, o, yn)
                      , c = I(re, a, 0, 5);
                    return "data:" === c || "blob:" === c && 5 === I(ae, a, location.origin + "/") ? _n(e, n, a, r, i, t) : (bn[e.id] = {
                        __proto__: null,
                        realm: t,
                        [x]: r,
                        [v]: e[v]
                    ...
                    r && !i && P(o, yn),
                    !Te && n.length > 1 && "usp" !== n[1] && (n = await $n(n[0], n[1]),
                    e.data = J ? J(n, e) : n),
                    e.ua = vn(),
                    et("HttpRequest", e))
                },
            ...
            lt({
                async HttpRequested(e) {
                    ...
                    if (!o)
                        return;
                    if (ee(e, "chunk"))
                        return void Mn(o, n, e);
                    let a = null == n ? void 0 : n[y];
                    null != a && (e.blobbed ? (a = await Ln(a, mn(o)),
                    et("RevokeBlob", a)) : e.chunked && (Mn(o, a),
                    a = o[hn],
                    delete o[hn],
                    mn(o) ? a = new O([a],{
                        type: e.contentType
            ...
            lt({
                TabClosed(e) {
                    ...
                    delete Tn[e],
                    delete Sn[t],
                    t && ut.post("TabClosed", t, n)
                }
            });
            const {[s]: Dn} = ut;
            async function Un(e) {
                const n = t.vmData || await H.race([new H(e=>{
                    t.vmResolve = e
                }
                ), e]);
                return delete t.vmResolve,
                delete t.vmData,
                n
            }
            function Pn() {
            ...
            (async()=>{
                ...
                ut.post("Expose", a[i])),
                ge(Dn).length && (it.forEach(e=>e(a)),
                await qt(a, e)),
                it.length = 0,
                Et(r)
            }
            )().catch(Te && Re.error),
            Te && 1 === Ee && "file:" === location.protocol && location.pathname.endsWith(".user.js") && "application/x-javascript" === Me.contentType && (async()=>{
                const {fetch: e, history: n} = t
                  , {referrer: o} = Me
                  , {text: a} = Z
                  , r = "cookie"in Document[L]
                  , i = location.href
                  , c = async()=>I(a, await e(i, {
                    mode: "same-origin"
                }));
                let s, l, d = await c();
                function u() {
                ...
                I(ae, d, "// ==UserScript==") < 0 || (await et("ConfirmInstall", {
                    code: d,
                    url: i,
                    from: o
                }),
                r ? fe.runtime.onConnect.addListener(e=>{
                    "FetchSelf" === e.name && (e.onMessage.addListener(async()=>{
                        try {
                            s && await s,
                            d = await (s = c())
                        } finally {
                    ...
                    e.onDisconnect.addListener(async()=>{
                        l = null,
                        await et("CheckInstallerTab", e.sender.tab.id) || u()
                    }
                    ))
                }
                ) : u())
